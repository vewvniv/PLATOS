...
| 4 | Sync · outbox · gate de pré-voo · modo degradado. **Não proponha a 4b antes de `slice-4a-cache-referencia` estar arquivada** — ver o ponto de não-retorno em §16 | Modelo offline |
